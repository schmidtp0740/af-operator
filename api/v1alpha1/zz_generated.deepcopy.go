...
func (in *CoreSpec) DeepCopyInto(out *CoreSpec) {
	*out = *in
	...
	if in.NodeOpSecretVolume != nil {
		in, out := &in.NodeOpSecretVolume, &out.NodeOpSecretVolume
		*out = new(v1.Volume)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *NodeSpec) DeepCopyInto(out *NodeSpec) {
	*out = *in
	if in.LocalPeers != nil {
		in, out := &in.LocalPeers, &out.LocalPeers
	...
	out.ConfigurationConfig = in.ConfigurationConfig
